...
with st.sidebar:
    st.title("MaternaInsight")
    st.write("Welcome to the MaternaInsight")
    st.write(" Choose an option from the menu below to get started:")

    selected = option_menu('MaternaInsight',
...
if (selected == 'About us'):
    ...
    st.title("Welcome to MaternaInsight")
    st.write("At MaternaInsight, our mission is to revolutionize healthcare by offering innovative solutions through predictive analysis. "
